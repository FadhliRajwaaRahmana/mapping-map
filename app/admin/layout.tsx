  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col md:ml-64">
        {/* Topbar — hidden on mobile (sidebar owns mobile top bar) */}
        <header className="sticky top-0 z-30 hidden h-14 items-center justify-between border-b-2 border-foreground bg-card px-4 md:flex md:px-6">
