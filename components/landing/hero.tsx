      ...
      <MotionConfig reducedMotion="user">
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          >
            ...
            <span className="text-sm font-medium">Mind map kolaboratif — gratis</span>
          </motion.div>
          ...
          >
            Petakan ide &amp; <span className="text-gradient">catatan teknismu</span>
          </motion.h1>
          ...
          >
            Mind map interaktif bergaya Excalidraw. Klik node untuk membuka detail Markdown, dan kolaborasi dengan tim secara langsung.
          </motion.p>
          ...
          >
            ...
            >
              <Link href={isLoggedIn ? "/maps" : "/register"}>
                {isLoggedIn ? "Buka Dashboard" : "Coba gratis"}
            ...
            {!isLoggedIn && (
              <Button asChild size="lg" variant="outline" className="border-2 border-foreground bg-card px-8 py-6 text-base font-bold shadow-brutal-sm transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:bg-accent hover:shadow-brutal">
          ...
          >
            <div className="relative rounded-lg border-2 border-foreground bg-card p-2 shadow-brutal-lg sm:p-3">
              <div className="mb-2 flex items-center gap-2 border-b border-border pb-2">
                ...
                <div className="flex-1 rounded-md bg-muted px-3 py-1 text-center text-xs text-muted-foreground">mapping.app/maps/demo</div>
              </div>
              <DemoCanvas />
            </div>
          </motion.div>
